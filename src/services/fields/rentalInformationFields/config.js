export const RENTAL_INFORMATION_FIELDS = [
    ...
    { key: 'If No, please provide details', source: 'textarea', outputKey: 'rentalDemandDetails', nextLabel: 'Monthly market rent sustainable assuming', textareaMapKey: 'rentalInformation_rentalDemandDetails' },
    ...
    { key: 'If Yes, please provide details', source: 'textarea', outputKey: 'otherLettingDemandDetails', nextLabel: 'Is the demand for this property only', textareaMapKey: 'rentalInformation_otherLettingDemandDetails' },
    { key: 'on an investor to investor basis?', source: 'checkbox', outputKey: 'investorOnlyDemand', yesLeft: 40.23, noLeft: 46.2 },
    { key: 'If Yes, please provide details', source: 'textarea', outputKey: 'investorOnlyDemandDetails', nextLabel: 'GENERAL REMARKS:', textareaMapKey: 'rentalInformation_investorOnlyDemandDetails' },
]