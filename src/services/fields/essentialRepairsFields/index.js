import { ESSENTIAL_REPAIRS_FIELDS } from './config.js';
import { extractTextareaFields } from '../../textareaFields/index.js';

export function buildEssentialRepairsGroup({ spans, checkbox, valueCols }) {
	const out = {};
	let textareaMap = null;
	for (const item of ESSENTIAL_REPAIRS_FIELDS) {
...
export { ESSENTIAL_REPAIRS_FIELDS };
