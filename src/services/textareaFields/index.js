...
const TEXTAREA_FIELDS = [
	...
	// Valuation for Finance Purposes (BTL): finance suitability details (No path)
	{
		label: 'If No, please provide details',
		labelIncludes: 'If No, please provide details',
		nextLabel: 'Market Value in present condition',
		nextLabelIncludes: 'Market Value in present condition',
		mapKey: 'valuationBTL_financeSuitabilityDetails',
		belowLabelIncludes: 'VALUATION FOR FINANCE PURPOSES',
		anchorBeforeIncludes: 'suitable security for finance purposes',
		// Right-column textbox (example left ~53.08%)
		answerLeftMin: 35.0,
		answerLeftMax: 95.0,
		includeSameRowRight: false,
		onlyRightOfA: true,
		...
		allowBMissing: true,
		stopAtMarkers: [
			'Market Value in present condition',
			'GENERAL REMARKS',
		],
		stripLabelPrefixes: true,
		stripTokens: ['If No, please provide details'],
	...
	// Valuation for Finance Purposes (BTL): insurance premium loading details (No path)
	{
		// In the template this is typically an "If Yes" details box under the insurance premium loading question
		label: 'If Yes, please provide details',
		labelIncludes: 'If Yes, please provide details',
		nextLabel: 'GENERAL REMARKS:',
		nextLabelIncludes: 'GENERAL REMARKS',
		mapKey: 'valuationBTL_insurancePremiumLoadingDetails',
		belowLabelIncludes: 'VALUATION FOR FINANCE PURPOSES',
		anchorBeforeIncludes: 'premium?',
		// Right-column textbox (example left ~53.08%)
		answerLeftMin: 35.0,
		answerLeftMax: 95.0,
		includeSameRowRight: false,
	...
	// Valuation for Finance Purposes (HPP): finance suitability details (No path)
	{
		label: 'If No, please provide details',
		labelIncludes: 'If No, please provide details',
		nextLabel: 'Market Value in present condition',
		nextLabelIncludes: 'Market Value in present condition',
		mapKey: 'valuationHPP_financeSuitabilityDetails',
		belowLabelIncludes: 'VALUATION FOR FINANCE PURPOSES',
		anchorBeforeIncludes: 'suitable security for finance',
		// HPP template places typed details in the left column (example left ~6.38%)
		answerLeftMin: 0.0,
		answerLeftMax: 30.0,
		includeSameRowRight: false,
		onlyRightOfA: false,
	...
	// Valuation for Finance Purposes (HPP): insurance premium loading details (No path)
	{
		// In the template this details box is typically on the "Yes" path for premium loading risk
		label: 'If Yes, please provide details',
		labelIncludes: 'If Yes, please provide details',
		nextLabel: 'GENERAL REMARKS:',
		nextLabelIncludes: 'GENERAL REMARKS',
		mapKey: 'valuationHPP_insurancePremiumLoadingDetails',
		belowLabelIncludes: 'VALUATION FOR FINANCE PURPOSES',
		anchorBeforeIncludes: 'premium',
		// HPP template places typed details in the left column (example left ~6.22%)
		answerLeftMin: 0.0,
		answerLeftMax: 30.0,
		includeSameRowRight: false,
		onlyRightOfA: false,
	...
	// Essential Repairs: details (bounded to 'Is re-inspection required?')
	{
		...
		stripLabelPrefixes: true,
		stripTokens: ['If Yes, please provide details'],
		// Some PDFs type only "YES" in this textbox; do not strip it as checkbox noise.
		stripCheckboxTokens: false,
		debug: false,
	},
	...
	for (const f of TEXTAREA_FIELDS) {
		...
		const value = extractBoundedAnswer(
			...
			spans,
			{
				...
				debug: f.debug,
					stripCheckboxTokens: f.stripCheckboxTokens,
